<!-- InstanceBegin template="/Templates/2012/Portal-2/1-Column.dwt.aspx" codeOutsideHTMLIsLocked="false" --><%@ Control language="vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.UI.Skins.Skin" %>
...
<div id="PageContainer">
	...
	<div id="ContentContainer">
		<div id="ContentPane" class="ContentPane" runat="server"><!-- InstanceBeginEditable name="ContentPane" --><dnn:PAGETITLE runat="server" id="dnnPAGETITLE" CssClass="page-title Head"/><!-- InstanceEndEditable --></div>
