...
<%@ Register TagPrefix="dnn" TagName="PRINTERFRIENDLY" Src="~/DesktopModules/Inventua - PrinterFriendlyLink/PrinterFriendlyLink.ascx" %>
<!-- InstanceEndEditable -->
	...
	<div id="ContentContainer">
		...
		<div id="ColumnsContainer">
			...
			<div id="RightColumns">
				...
				<div id="RightPane" class="RightPane" runat="server"><!-- InstanceBeginEditable name="RightPane" --><dnn:PRINTERFRIENDLY runat="server" id="dnnPRINTERFRIENDLY" text="Printer-Friendly" image="~\images\print.gif" skinsrc="[G]Skins\Printer-Friendly\print" CssClass="printButton"/><!-- InstanceEndEditable --></div>
			</div>
		</div>
