<%@ Control language="C#" AutoEventWireup="false" Inherits="DotNetNuke.UI.Skins.SkinObjectBase" %>

<div class="row">
	<div class="col-sm-3 col-lg-2"><strong><a href="/About.aspx">ABOUT</a></strong>
		<ul>
			<li class="li"><a href="/About/GPABoardMembers.aspx">GPA Board Members</a></li>
			<li class="li"><a href="/About/ExecutiveStaff.aspx">Executive Staff</a></li>
			<li class="li"><a href="/About/EconomicImpact">Economic Impact</a></li>
		...
		<ul>
			<li class="li"><a href="/PortofSavannah/GardenCityTerminal.aspx">Garden City Terminal</a></li>
			<li class="li"><a href="/PortofSavannah/OceanTerminal.aspx">Ocean Terminal</a></li>
		</ul>
	...
	<div class="col-sm-3 col-lg-2"><strong>DEPARTMENTS</strong>
		<ul>
			...
			<li class="li"><a href="/Departments/Purchasing.aspx">Purchasing</a></li>
			...
			<li class="li"><a href="/Departments/FacilitiesManagement.aspx">Facilities Management</a></li>
			<li class="li"><a href="/Departments/RiskManagement.aspx">Risk Management</a></li>
		</ul>
	</div>
	<div class="col-sm-3 col-lg-2"><strong>CARGO SOLUTIONS</strong>
		<ul>
			...
			<li class="li"><a href="/PortofSavannah/OceanTerminal/BreakBulk.aspx">Break Bulk</a></li>
			<li class="li"><a href="/PortofSavannah/OceanTerminal/HeavyLift.aspx">Heavy Lift</a></li>
			
			<!--                    /PortofBrunswick/MayorsPointTerminal/BreakBulk -->
			<li class="li"><a href="/PortofBrunswick/MayorsPointTerminal/ForestryProducts.aspx">Forestry Products</a></li>
			<li class="li"><a href="/PortofBrunswick/ColonelsIslandTerminalAgriBulk/AgriBulk.aspx">Agri-Bulk</a></li>
			
		</ul>
		<strong>FACILITIES</strong>
		<ul>
			<li class="li"><a href="/Facilities/PortofBainbridge.aspx">Port of Bainbridge</a></li>
			<li class="li"><a href="/Facilities/PortofColumbus.aspx">Port of Columbus</a></li>
			<li class="li"><a href="/Facilities/MarinePortsTerminal.aspx">Marine Ports Terminal</a></li>
		</ul>
	</div>
